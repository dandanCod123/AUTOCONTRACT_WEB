    ...
    <div class="container text-center">
        ...
        <div class="row">
            ...
            <div class="col-8 bg-dark">
                    ...
                    <div class="p-3">
                        <form method="post" action="editar_dados">    
                            <div class="form row">
                            ...
                            <div class="row">
                                <div class="col-3"></div>
                                    <div class="col-6 text-center" style="color: white;">
                                        <button type="submit" style="font-family:'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;" class="btn btn-light"> Salvar</button>
                                    </div>
                            </div>
                        </form>
                    </div>
