...
function instrucoes(){
    alert('É necessário que os dados sejam buscados antes de poder gerar o relatório, após buscar os dados o botão ficará azul e será possível gerar o documento')
};
