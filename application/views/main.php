...
<html lang="pt-br">
  ...
  <body  style="background-color:grey">
    ...
    <nav class="navbar navbar-expand-lg bg-dark">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 ">
                <li class="nav-item">
                    <a class="nav-link active" style="color: white" aria-current="page" href="#">Menu</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link " style="color: white" href="index.php/cliente/add_dados">Adicionar Dados</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link " style="color: white" href="index.php/cliente/get_dados">Gerar Documentos</a>
                </li>
                <li>
                    <a class="nav-link " style="color: white" href="index.php/cliente/update_dados">Editar Dados</a>
                </li> 
            </ul>
            </div>
        </div>
    ...
    <div class="container text-center">
        <br>
        <br> 
        <h1 style="font-family:'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif">&#9733; AutoContract &#9733;</h1>
        <br>
        <p style="font-family:'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif ; font-size: 18px; text-align:center">O AutoContract é a ferramenta
        ideal para facilitar a execução de contratos na sua empresa. Se você deseja utilizar o sistema, basta clicar nas abas do sistema. 
        </p>
        <br>
        <br>
        <br>
